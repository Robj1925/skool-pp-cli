...
func newEnvelopePromotedCmd(flags *rootFlags) *cobra.Command {
	var flagSentryClient string
	...
	cmd.Flags().StringVar(&flagSentryClient, "sentry-client", "", "")
	cmd.Flags().IntVar(&flagSentryVersion, "sentry-version", 0, "")
