...
func newGroupsGetMemberCoursePermissionsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/groups/{hash}/member-course-permissions"
	...
	cmd.Flags().StringVar(&flagMember, "member", "", "")
