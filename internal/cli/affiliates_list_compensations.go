...
func newAffiliatesListCompensationsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/affiliates/v2/compensations"
			params := map[string]string{}
			if flagCancelled != false {
				params["cancelled"] = fmt.Sprintf("%v", flagCancelled)
			}
			if flagGroupId != "" {
	...
	cmd.Flags().BoolVar(&flagCancelled, "cancelled", false, "")
