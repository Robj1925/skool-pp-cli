...
func newNextGetMapJsonCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			path := "/_next/data/{id}/ai-academy-with-robby-6849/-/map.json"
			if len(args) < 2 {
			...
			if flagIs != 0 {
				params["is"] = fmt.Sprintf("%v", flagIs)
			}
